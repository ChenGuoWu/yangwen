	...
	<div class="organization">
		...
		<div class="one_level">
			...
			<div class="table_content" v-loading="loading">
				<div class="table_box">
					<el-table height="100%" @selection-change="handleSelectionChange" :header-cell-style="{background:'#E1E8F4',color:'#333333',fontWeight:'bold'}" :data="tableData" :cell-style="{padding: '0'}" :row-style="{height: '0.4rem'}" style="width: 100%; margin-bottom: 20px;">
						<el-table-column
							align="center"
							type="selection"
							width="55">
						...
						<el-table-column :show-overflow-tooltip="true" prop="ruleTitle" label="规章标题" width="380">
							<template slot-scope="scope">
								<span style="cursor: pointer; color: #2084F2;">{{scope.row.ruleTitle}}</span>
							</template>
						</el-table-column>
						<el-table-column :show-overflow-tooltip="true" prop="ruleDocNo" label="规章文号" width="154">
						</el-table-column>
						<el-table-column :show-overflow-tooltip="true" prop="ruleNo" label="规章编号" width="154">
						</el-table-column>
						...
						<el-table-column align="center" label="操作">
							<template slot-scope="scope">
								<el-button v-if="scope.row.ruleExpStatus == 'DIC-0019' || scope.row.ruleExpStatus == 'DIC-0020'" style="padding: 0 0.1rem;" @click="editData(scope.row)" type="text" size="small">编辑</el-button>
								<el-button v-if="scope.row.ruleExpStatus == 'DIC-0019' || scope.row.ruleExpStatus == 'DIC-0020'" style="color: #FF3D3D; padding: 0 0.1rem;" @click="deleteData(scope.row)" type="text" size="small">删除</el-button>
							</template>
						</el-table-column>
					</el-table>
				</div>
			...
			<el-form style="margin:0.2rem 0.2rem 0px 0px;" ref="addForm" :rules="rules" :model="addForm" label-width="120px">
				...
				<el-form-item class="role_number"  label="技术规章编号" v-if="orgInfo.unitLevel != 'DIC-004'">
					<div class="number_item">
						<el-input v-model="addForm.ruleNoCode" @input="capitalize(addForm.ruleNoCode, 'ruleNoCode')" class="number_key"></el-input>
						<span>规章</span>
					</div>
					<div class="number_item">
						<span>/</span>
					...
					<div class="number_item">
						<el-input v-model="addForm.ruleNoDomain" @input="capitalize(addForm.ruleNoDomain, 'ruleNoDomain')" class="number_key"></el-input>
						<span>专业</span>
					</div>
					<div class="number_item">
						<el-input v-model="addForm.ruleNoSn" @input="capitalize(addForm.ruleNoSn, 'ruleNoSn')" class="number_key"></el-input>
						<span>顺序</span>
					</div>
					<div class="number_item">
						<el-input v-model="addForm.ruleNoRev" @input="capitalize(addForm.ruleNoRev, 'ruleNoRev')" class="number_key"></el-input>
						<span>修订</span>
					</div>
					<div class="number_item">
						<span>——</span>
				...
				<el-form-item class="is_required" label="规章文号" v-if="orgInfo.unitLevel != 'DIC-004'">
					<el-input class="writing_item" @input="capitalize(addForm.ruleDocNo1, 'ruleDocNo1')" v-model="addForm.ruleDocNo1"></el-input>
					<span style="padding: 0 0.05rem;">〔</span>
					<el-input class="writing_item" @input="capitalize(addForm.ruleDocNo2, 'ruleDocNo2')" v-model="addForm.ruleDocNo2"></el-input>
					<span style="padding: 0 0.05rem;">〕</span>
					<el-input class="writing_item" @input="capitalize(addForm.ruleDocNo3, 'ruleDocNo3')" v-model="addForm.ruleDocNo3"></el-input>
					<span>号</span>
				</el-form-item>
				<el-form-item label="技术规章编号" prop="ruleNo" v-if="orgInfo.unitLevel == 'DIC-004'">
					<el-input @input="capitalize(addForm.ruleNo, 'ruleNo')" v-model="addForm.ruleNo"></el-input>
				</el-form-item>
				<el-form-item label="规章文号" prop="ruleDocNo" v-if="orgInfo.unitLevel == 'DIC-004'">
					<el-input @input="capitalize(addForm.ruleDocNo, 'ruleDocNo')" v-model="addForm.ruleDocNo"></el-input>
				</el-form-item>
				<el-form-item label="负责部门" prop="deptInCharge">
					<el-input v-model="addForm.deptInCharge"></el-input>
				</el-form-item>
				<el-form-item prop="ruleType" label="规章类别">
					<el-select v-model="addForm.ruleType" clearable>
				...
				<el-form-item label="专业" v-if="orgInfo.unitLevel != 'DIC-004'">
					<el-select v-model="addForm.ruleDomain" clearable>
						<el-option v-for="item in majorList" :label="item.dicName" :value="item.dicCode" :key="item.dicCode"></el-option>
					</el-select>
				</el-form-item>
